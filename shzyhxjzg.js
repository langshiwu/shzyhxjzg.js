(function(window) {
  function assert() {
    for (
      var _len = arguments.length, express = Array(_len), _key = 0;
      _key < _len;
      _key++
    ) {
    ...
    try {
      for (
        var _iterator = express[Symbol.iterator](), _step;
  ...
  function hex2duo(hexs) {
    ...
    try {
      for (
        var _iterator2 = hexs[Symbol.iterator](), _step2;
  ...
  window.shzyhxjzgDecode = function(encoded) {
    var duo = [];
    ...
    try {
      for (
        var _iterator3 = encoded[Symbol.iterator](), _step3;
  ...
  window.shzyhxjzgEncode = function(str) {
